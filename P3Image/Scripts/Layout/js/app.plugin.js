!function ($) {
  ...
  $(function(){
	...
	//    var isFormValid = $target.parent().find(".form-content").valid();

	//    if ($(this).hasClass('btn-next') && $step.find('input, select, textarea').data('required') &&
    //        !$step.find('input, select, textarea').parsley('validate') || !isFormValid) {
	//        return false;
	//    }
	//    else {
